...
const courtCards = ['Knight', 'Queen', 'King'] as const;
...
export default function StrategyPage() {
  ...
  const [courtCard, setCourtCard] = useState<(typeof courtCards)[number]>('Knight');
  ...
  useEffect(() => {
    ...
    const routeTimer = window.setTimeout(() => router.push(`/live/${encodeURIComponent(symbol)}?transition=lens`), 2000);
    return () => {
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 py-6 sm:px-8 lg:px-12">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.25fr_0.75fr]">
          <section className="relative border border-cyan-200/15 bg-white/[0.025] p-3 sm:p-5" aria-label="3D strategy sandbox">
            ...
            <StrategySandbox isStrategyLocked={isStrategyLocked} className="h-[56vh] min-h-[430px] w-full" />
